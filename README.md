...
to commission a design. Allow users to access additional services such as repairs and evening classes. 
...
of a collapsed fixed navbar and buttons on the home page to encourage user interaction with the rest of the site. For larger devices a fixed top 
navbar will provide clear and easy access to all other pages.
...
## Testing User/ Business Owner Stories
